...
z_0 = 50.0
Z_0 = 50.0
L_bridge = 1/1000000000000
C_gnd = 1/2000000000000000
...
function build_networks(w, k)
    ...
    push!(networks, ("AS2", let
        Y1 = im*w/2000000000000000
        ComplexF64.(JosephsonCircuits.AtoS(ComplexF64.(JosephsonCircuits.ABCD_shuntY(Y1))))
    end))
...
println("Running solveS on airbridge_signal2signal__p_ff5ba53951.json...")
...
save_s_matrix("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_uz__3i91/cache/airbridge_signal2signal__p_ff5ba53951_095b304fb963ba3c.csv", ws, S_first)
println("Saved solveS cache to airbridge_signal2signal__p_ff5ba53951_095b304fb963ba3c.csv")
