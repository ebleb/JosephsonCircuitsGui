...
function apply_port_order(S_k, sol_ports)
    expected_ports = [("ACT1", 1), ("AT2", 2), ("ACT1", 3), ("AS2", 2)]
...
function build_networks(w, k)
    ...
    push!(networks, ("AS2", load_s_matrix_at("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_bnpa1xom/cache/airbridge_signal2signal__p_ff5ba53951_9a16e0f9a2a0fbe0.csv", k)))
...
function build_connections()
    ...
    push!(connections, [("ACT1", 4), ("AT1", 1)])
    push!(connections, [("AT1", 2), ("AS2", 1)])
    push!(connections, [("ACT1", 2), ("AS1", 1)])
    push!(connections, [("AS1", 2), ("AT2", 1)])
...
println("Running solveS on ring_module__p_65c28c0c3b.json...")
...
save_s_matrix("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_bnpa1xom/cache/ring_module__p_65c28c0c3b_c03c9042440c1f19.csv", ws, S_first)
println("Saved solveS cache to ring_module__p_65c28c0c3b_c03c9042440c1f19.csv")
