...
function build_networks(w, k)
    ...
    push!(networks, ("ICM1", load_s_matrix_at("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_bnpa1xom/cache/io_coupler_module__p_df41925917_75ffd49970cf4a25.csv", k)))
    push!(networks, ("ICM2", load_s_matrix_at("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_bnpa1xom/cache/io_coupler_module__p_df41925917_75ffd49970cf4a25.csv", k)))
    ...
    push!(networks, ("AS1", load_s_matrix_at("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_bnpa1xom/cache/airbridge_signal2signal__p_ff5ba53951_9a16e0f9a2a0fbe0.csv", k)))
    push!(networks, ("ACT1", let
        Z0e = 1995976205172263/25000000000000
        Z0o = 31268051050244907/1000000000000000
        thetae = 2087637902408164877*w/50000000000000000000000000000
        thetao = 3941202055654490879*w/93750000000000000000000000000
...
println("Running solveS on output_module__p_afff781573.json...")
...
save_s_matrix("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_bnpa1xom/cache/output_module__p_afff781573_3ac5d7cae604588f.csv", ws, S_first)
println("Saved solveS cache to output_module__p_afff781573_3ac5d7cae604588f.csv")
