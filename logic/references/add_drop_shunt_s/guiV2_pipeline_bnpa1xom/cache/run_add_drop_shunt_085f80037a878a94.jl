...
function build_networks(w, k)
    ...
    push!(networks, ("AD1", load_s_matrix_at("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_bnpa1xom/cache/add_drop_0f55ad919a6fec7c.csv", k)))
...
println("Running solveS on add_drop_shunt.json...")
...
save_s_matrix("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_bnpa1xom/cache/add_drop_shunt_085f80037a878a94.csv", ws, S_first)
println("Saved solveS cache to add_drop_shunt_085f80037a878a94.csv")
