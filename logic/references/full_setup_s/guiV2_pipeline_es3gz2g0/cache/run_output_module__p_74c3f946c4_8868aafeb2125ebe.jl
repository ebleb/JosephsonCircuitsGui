...
function build_networks(w, k)
    ...
    push!(networks, ("ICM1", load_s_matrix_at("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_es3gz2g0/cache/io_coupler_module__p_4d58e1cf70_8d408eeea2fc7e8a.csv", k)))
    push!(networks, ("ICM2", load_s_matrix_at("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_es3gz2g0/cache/io_coupler_module__p_4d58e1cf70_8d408eeea2fc7e8a.csv", k)))
    ...
    push!(networks, ("AT3", let
        Z0 = 50
        theta = 10961314453730823413*w/625000000000000000000000000000
        ComplexF64.(JosephsonCircuits.AtoS(ComplexF64.(JosephsonCircuits.ABCD_tline(Z0, theta))))
    end))
    ...
    push!(networks, ("ACT1", let
        ...
        thetae = 3518475143124571033*w/100000000000000000000000000000
        thetao = 6642445728186714691*w/187500000000000000000000000000
...
println("Running solveS on output_module__p_74c3f946c4.json...")
...
save_s_matrix("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_es3gz2g0/cache/output_module__p_74c3f946c4_8868aafeb2125ebe.csv", ws, S_first)
println("Saved solveS cache to output_module__p_74c3f946c4_8868aafeb2125ebe.csv")
