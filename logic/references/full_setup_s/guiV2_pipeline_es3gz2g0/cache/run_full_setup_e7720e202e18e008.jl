...
function apply_port_order(S_k, sol_ports)
    expected_ports = [("FI1", 1), ("SE1", 1), ("FI1", 2)]
...
function build_networks(w, k)
    ...
    push!(networks, ("FI1", load_s_matrix_at("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_es3gz2g0/cache/first_half_01ad3fe05c50e0ec.csv", k)))
    push!(networks, ("SE1", load_s_matrix_at("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_es3gz2g0/cache/second_half_167835c3e8ed3f5c.csv", k)))
...
function build_connections()
    ...
    push!(connections, [("FI1", 3), ("SE1", 2)])
    push!(connections, [("FI1", 2), ("SE1", 3)])
...
println("Running solveS on full_setup.json...")
...
save_s_matrix("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_es3gz2g0/cache/full_setup_e7720e202e18e008.csv", ws, S_first)
println("Saved solveS cache to full_setup_e7720e202e18e008.csv")
