...
function save_hbsolve_result()
    ...
    writedlm("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_es3gz2g0/cache/twpa_72b05a9c56a8a2b2.csv", out_data, ',')
end
...
save_hbsolve_result()
save_nodeflux_csv("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_es3gz2g0/cache/twpa_72b05a9c56a8a2b2_nodeflux.csv")
println("Saved HBSolve cache to twpa_72b05a9c56a8a2b2.csv")
println("Saved nodeflux cache to twpa_72b05a9c56a8a2b2_nodeflux.csv")
...
function save_multimode_hbsolve_result()
    ...
    # Save metadata.
    open("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_es3gz2g0/cache/twpa_72b05a9c56a8a2b2_multimode_modes.json", "w") do io
        println(io, "{")
    ...
    writedlm("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_es3gz2g0/cache/twpa_72b05a9c56a8a2b2_multimode_full.csv", full_out, ',')
    ...
    writedlm(
        "/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_es3gz2g0/cache/twpa_72b05a9c56a8a2b2_multimode_power.csv",
        vcat(
            reshape([
                "mode_n",
    ...
    writedlm(
        "/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_es3gz2g0/cache/twpa_72b05a9c56a8a2b2_multimode_conversions.csv",
    ...
    println("  saved power stats                 = /home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_es3gz2g0/cache/twpa_72b05a9c56a8a2b2_multimode_power.csv")
    println("  saved targeted conversions        = /home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_es3gz2g0/cache/twpa_72b05a9c56a8a2b2_multimode_conversions.csv")
    ...
    writedlm(
        "/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_es3gz2g0/cache/twpa_72b05a9c56a8a2b2_multimode_diagnostics.csv",
        vcat(
            reshape([
                "frequency_GHz",
    ...
    println("Saved multimode full CSV: /home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_es3gz2g0/cache/twpa_72b05a9c56a8a2b2_multimode_full.csv")
    println("Saved multimode metadata: /home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_es3gz2g0/cache/twpa_72b05a9c56a8a2b2_multimode_modes.json")
    println("Saved multimode diagnostics: /home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_es3gz2g0/cache/twpa_72b05a9c56a8a2b2_multimode_diagnostics.csv")
end
