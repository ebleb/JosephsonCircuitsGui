...
function build_networks(w, k)
    ...
    push!(networks, ("RM1", load_s_matrix_at("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_es3gz2g0/cache/ring_module__p_95892ed906_7826f247e0786ac6.csv", k)))
    push!(networks, ("OM1", load_s_matrix_at("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_es3gz2g0/cache/output_module__p_b92d1e3a2d_3ee316d781c6955a.csv", k)))
    push!(networks, ("IM1", load_s_matrix_at("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_es3gz2g0/cache/input_module__override_add_drop_IM1__p_7b6f37accc_4bb92f7c473cd3d8.csv", k)))
...
println("Running solveS on add_drop__override_second_half_AD3.json...")
...
save_s_matrix("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_es3gz2g0/cache/add_drop__override_second_half_AD3_d779f343ed9f58ec.csv", ws, S_first)
println("Saved solveS cache to add_drop__override_second_half_AD3_d779f343ed9f58ec.csv")
