...
function build_networks(w, k)
    ...
    push!(networks, ("RM1", load_s_matrix_at("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_es3gz2g0/cache/ring_module__p_da3be03264_bfd40ccc2b7cedee.csv", k)))
    push!(networks, ("OM1", load_s_matrix_at("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_es3gz2g0/cache/output_module__p_74c3f946c4_8868aafeb2125ebe.csv", k)))
    push!(networks, ("IM1", load_s_matrix_at("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_es3gz2g0/cache/input_module__override_add_drop_IM1__p_2260d9d004_4b2386572c43dd5d.csv", k)))
...
println("Running solveS on add_drop__override_second_half_AD2.json...")
...
save_s_matrix("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_es3gz2g0/cache/add_drop__override_second_half_AD2_f50e711227230a5e.csv", ws, S_first)
println("Saved solveS cache to add_drop__override_second_half_AD2_f50e711227230a5e.csv")
