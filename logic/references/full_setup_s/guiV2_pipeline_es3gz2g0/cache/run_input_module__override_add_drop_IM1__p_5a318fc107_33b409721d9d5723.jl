...
function build_networks(w, k)
    ...
    push!(networks, ("ICM1", load_s_matrix_at("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_es3gz2g0/cache/io_coupler_module__p_d5840a5c8e_871ff25d0adb24ae.csv", k)))
    ...
    push!(networks, ("ICM2", load_s_matrix_at("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_es3gz2g0/cache/io_coupler_module__p_d5840a5c8e_871ff25d0adb24ae.csv", k)))
...
println("Running solveS on input_module__override_add_drop_IM1__p_5a318fc107.json...")
...
save_s_matrix("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_es3gz2g0/cache/input_module__override_add_drop_IM1__p_5a318fc107_33b409721d9d5723.csv", ws, S_first)
println("Saved solveS cache to input_module__override_add_drop_IM1__p_5a318fc107_33b409721d9d5723.csv")
