...
Ip = [0.00565e-6*1.7, 0.00565e-6*1.7]
Idc = Float64[]
sources = [(mode=(1,0), port=1, current=Ip[1]), (mode=(0,1), port=1, current=Ip[2])]
...
println("Running X-parameter hbsolve on double_pumped_JPA.json...")
xp = hbsolve_xparams(
    ws,
    wp,
    Ip,
...
Nmodes = length(modes)
sig_idx = findfirst(m -> m == (0,0), modes)
sig_idx === nothing && error("Signal mode (0,0) was not found in linearized modes.")
...
save_s_matrix("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_w5c514mh/cache/double_pumped_JPA_f5b6f6ade721387a.csv", ws, S_signal)
save_s_matrix("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_w5c514mh/cache/double_pumped_JPA_f5b6f6ade721387a_x_XS_full.csv", ws, XS_saved)
save_s_matrix("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_w5c514mh/cache/double_pumped_JPA_f5b6f6ade721387a_x_XT_full.csv", ws, XT_saved)
save_xfb_csv("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_w5c514mh/cache/double_pumped_JPA_f5b6f6ade721387a_x_XFB.csv", xp)
save_x_modes_json("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_w5c514mh/cache/double_pumped_JPA_f5b6f6ade721387a_x_modes.json", xp)
save_nodeflux_csv("/home/benedikte/userdata/urop/app_v2_pub/logic/outputs/guiV2_pipeline_w5c514mh/cache/double_pumped_JPA_f5b6f6ade721387a_nodeflux.csv", xp)

println("Saved X-compatible signal S cache to double_pumped_JPA_f5b6f6ade721387a.csv")
